        ...
        $this->initial->custom->get($JDTUrl, function ($error, $response, $data) use ($stop, $code) {
            try {
                if ($error) {
                    ...
                    $also = $this->initial->merge->JDTurn->notify ? true : false;
                    if ($cc['code'] == 3) {
