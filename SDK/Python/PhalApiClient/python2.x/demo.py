...
print '-' * 20
print 'Request: 1'
result = PhalApiClient.PhalApiClient('http://demo.phalapi.net/', 'Default.Index', {'user_name': 'dogstar'}, 3)
print 'head', result['info']
print 'state', result['state']
print 'result', result['data']
print '-' * 20
print 'Request: 2'
result = PhalApiClient.PhalApiClient('http://demo.phalapi.net/', 'User.GetBaseInfo', {'user_name': 'dogstar'})
print 'head', result['info']
print 'state', result['state']
print 'result', result['data']
print '-' * 20
