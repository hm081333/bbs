...
class Status extends Command
{
     ...
     * @var string
     */
    protected $description = '显示OPCache状态';
    ...
    protected function displayTables($data)
    {
        ...
        foreach (['memory_usage', 'interned_strings_usage', 'opcache_statistics', 'preload_statistics', 'jit', 'scripts'] as $unset) {
            unset($general[$unset]);
        }
        ...
        if (isset($data['jit'])) {
            $this->line(PHP_EOL . 'Just In Time:');
